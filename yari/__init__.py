...
@click.option(
    ...
    "Champion, Eldritch Knight, Samurai), Monk (Way of Shadow, Way of the Four "
    "Elements, Way of the Open Hand), Paladin (Oath of the Ancients, Oath of Devotion, Oath of "
