...
Enter a number >> 3
INFO: You set your alignment to > Lawful Evil.
...
Enter a number >> 2
INFO: Character background 'Criminal' chosen.
...
Enter a number >> 1
INFO: Character language 'Celestial' chosen.
INFO: Using a non-dominant gender height differential of -3".
INFO: Using a non-dominant gender weight differential of -0.15%.
What level are you? 
...
Choose class option 'skills' (2): 
[mtt@seikou Yari]$ ls
_config.yml  LICENSE  README.md  requirements.txt  yari
[mtt@seikou Yari]$ python yari -s Female -r Human
What is your chosen alignment? 
